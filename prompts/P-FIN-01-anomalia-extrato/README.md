...
**Domínio:** Financeiro
**Caso de uso:** Identificação de transações anômalas em extrato bancário para revisão manual
**Modelo recomendado:** Haiku equivalente para alto volume, Sonnet para casos com explicação narrativa
